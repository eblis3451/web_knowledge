...
<div style="clear:both"></div></div></div><span class="textstyle5"><br/></span><div id="container_261211a2"><div class="textstyle1">  <a href="index.php" style="text-decoration:none"><div id="button_64589801">
  ...
  <a href="advisor.php" style="text-decoration:none"><div id="button_33ab7473">
  ...
  <a href="about.php" style="text-decoration:none"><div id="button_9faa198">
    <div class="vcenterstyle1"><div class="vcenterstyle2">      <div class="textstyle2">
        </div>
      <div class="textstyle1">
  ...
  <a href="thesis.php" style="text-decoration:none"><div id="button_18bafa13">
    <div class="vcenterstyle1"><div class="vcenterstyle2">      <div class="textstyle2">
        </div>
      <div class="textstyle1">
  ...
  <a href="members.php" style="text-decoration:none"><div id="button_12299969">
    <div class="vcenterstyle1"><div class="vcenterstyle2">      <div class="textstyle2">
        </div>
      <div class="textstyle1">
...
<form action="advisor.php" method="post" >
  <textarea id="text" rows=5% cols=30%   style="display:none" name="title_textbox"  ><?php echo "$title"?></textarea><br>
...
<?php
error_reporting(0); 
if(($_POST['title_textbox']!= null)){
  $title_textbox = $_POST['title_textbox'];
  $sql ="UPDATE `advisor` SET `title`= '$title_textbox'  WHERE `id`='1'";
  $result = mysqli_query($con, $sql);
  echo "<script> window.location.href = 'advisor.php' </script> "; 
  $_POST['title_textbox']="";//清乾淨post值
}
?>
...
<!--顯示與隱藏要修改的"自介文"-->
<button type="button" onclick="showtext_biography()">修改</button>
<script>
function showtext_biography()
{
  document.getElementById("text_biography").style="display:block" 
  document.getElementById("sumbittext_biography").style="display:block" 
} 
</script>

<!--"自介文"與提交送出-->  
<form action="advisor.php" method="post" >
  <textarea id="text_biography" rows=20% cols=80%   style="display:none" name="biography_textbox"  ><?php echo "$title"?></textarea><br>
  <input type="submit" id="sumbittext_biography" style="display:none">
</form>

<!--修改"自介文"的sql(model)-->
<?php

if(($_POST['biography_textbox']!= null)){
  $biography_textbox = $_POST['biography_textbox'];
  $sql ="UPDATE `advisor` SET `biography`= '$biography_textbox'  WHERE `id`='1'";
  $result = mysqli_query($con, $sql);
  echo "<script> window.location.href = 'advisor.php' </script> "; 
  $_POST['biography_textbox']="";
}
?>
...
<!--顯示與隱藏要修改的"課程"-->
<button type="button" onclick="showtext_course()">修改</button>
<script>
function showtext_course()
{
  document.getElementById("text_course").style="display:block" 
  document.getElementById("sumbittext_course").style="display:block" 
} 
</script>

<!--"課程"與提交送出-->  
<form action="advisor.php" method="post" >
  <textarea id="text_course" rows=20% cols=80%   style="display:none" name="course_textbox"  ><?php echo "$course"?></textarea><br>
  <input type="submit" id="sumbittext_course" style="display:none">
</form>

<!--修改"課程"的sql(model)-->
<?php
if(($_POST['course_textbox']!= null)){
  $course_textbox = $_POST['course_textbox'];
  $sql ="UPDATE `advisor` SET `course`= '$course_textbox'  WHERE `id`='1'";
  $result = mysqli_query($con, $sql);
  echo "<script> window.location.href = 'advisor.php' </script> "; 
  $_POST['course_textbox']="";
}
?>
...
<!--顯示與隱藏要修改的"得獎"-->
<button type="button" onclick="showtext_awards()">修改</button>
<script>
function showtext_awards()
{
  document.getElementById("text_awards").style="display:block" 
  document.getElementById("sumbittext_awards").style="display:block" 
} 
</script>

<!--"得獎"與提交送出-->  
<form action="advisor.php" method="post" >
  <textarea id="text_awards" rows=20% cols=80%   style="display:none" name="awards_textbox"  ><?php echo "$awards"?></textarea><br>
  <input type="submit" id="sumbittext_awards" style="display:none">
</form>

<!--修改"得獎"的sql(model)-->
<?php
if(($_POST['awards_textbox']!= null)){
  $awards_textbox = $_POST['awards_textbox'];
  $sql ="UPDATE `advisor` SET `awards`= '$awards_textbox'  WHERE `id`='1'";
  $result = mysqli_query($con, $sql);
  echo "<script> window.location.href = 'advisor.php' </script> "; 
  $_POST['awards_textbox']="";
}
?>
