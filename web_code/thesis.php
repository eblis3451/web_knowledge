...
<div style="clear:both"></div></div></div><span class="textstyle5"><br/></span><div id="container_639a229a"><div class="textstyle1">  <a href="index.php" style="text-decoration:none"><div id="button_10bc54f8">
  ...
  <a href="advisor.php" style="text-decoration:none"><div id="button_73838185">
  ...
  <a href="about.php" style="text-decoration:none"><div id="button_9663379">
    <div class="vcenterstyle1"><div class="vcenterstyle2">      <div class="textstyle2">
        </div>
      <div class="textstyle1">
  ...
  <a href="thesis.php" style="text-decoration:none"><div id="button_69cdf215">
    <div class="vcenterstyle1"><div class="vcenterstyle2">      <div class="textstyle2">
        </div>
      <div class="textstyle1">
  ...
  <a href="members.php" style="text-decoration:none"><div id="button_358eafcd">
    <div class="vcenterstyle1"><div class="vcenterstyle2">      <div class="textstyle2">
        </div>
      <div class="textstyle1">
...
<div class="textstyle1"><div id="container_4a2f61ca"><div id="container_4a2f61ca_padding" ><div class="textstyle1"><div id="container_6b753925"><div id="container_6b753925_padding" ><div class="textstyle2">  <span class="textstyle7">Here is the graduate thesis written by Past student</span>
    ...
    <td width="13%" height="22px" style="vertical-align: top; overflow:hidden; background-color:#FF8040; ">  <div id="cell_7d766d63">
    <div class="textstyle1">
      <span class="textstyle8">delete</span>
      </div>
    </div>
    </td>
	</tr>
  ...
  while ($row = mysqli_fetch_array($result, MYSQLI_NUM)) {
    ...
    <td width='13%' height='22px' style='vertical-align: top; overflow:hidden; background-color:#21201C; '>
      <div class='textstyle1'>";
            //刪除鍵
    $delet_id=$row[0];
    echo "<form action='thesis_model/thesis_del.php' method='get' >";
    echo"<a href='thesis_model/thesis_del.php?id= $delet_id'>刪除</a></br></form>";
    echo  " </div>
    </td>
...
<!--顯示與隱藏新增"論文"-->
<button type="button" onclick="showtext()">新增論文</button>;
<script>
function showtext()
{
...
<!--新增"論文"&圖片-->
<form action="thesis_model/thesis_add.php" method="GET">
    <input type="text" size="40" id="text1"  name="publisher" style="display:none" placeholder="請填入發行人或相關資訊">
    <input type="text" size="60" id="text2"  name="paper_name" style="display:none" placeholder="請填入論文名稱">
    <input type="text" size="60" id="text3"  name="link" style="display:none" placeholder="請填入相關連結">
